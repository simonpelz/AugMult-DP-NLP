...
class Augmentations:
    def __init__(self):
        ...
        # TODO FIXME load models correctly
        #self.synonym_ppdb = naw.SynonymAug(aug_src='ppdb').augment
        #self.emb_replace = naw.WordEmbsAug(model_type='word2vec',action="substitute").augment
        #self.emb_insert = naw.WordEmbsAug(model_type='word2vec',action="insert").augment
    ...
    def eda(self):
        transformation_list = [self.unaugmented,self.synonym_wn,]
